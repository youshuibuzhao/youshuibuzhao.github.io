...
<nav class="page-nav">
  <div class="page-nav__inner">
    <div class="page-nav__links">
      <a class="is-home lang-block" href="#top" data-lang="zh">🏠 首页</a>
      <a class="is-home lang-block" href="#top" data-lang="en">🏠 Homepage</a>
      <a class="lang-block" href="#about-me" data-lang="zh">👋 关于我</a>
      <a class="lang-block" href="#about-me-en" data-lang="en">👋 About Me</a>
      <a class="lang-block" href="#education" data-lang="zh">📚 教育</a>
      <a class="lang-block" href="#education-en" data-lang="en">📚 Education</a>
      <a class="lang-block" href="#skills" data-lang="zh">🧩 核心技能</a>
  ...
  <div class="page-grid">
    <aside class="sidebar">
      <div class="profile-card">
        <div class="avatar">
          <img src="{{ '/assets/images/证件照2.jpg' | relative_url }}" alt="Zhiyou Zhang">
        </div>
        ...
        <div class="contact-list lang-block" data-lang="zh">
          ...
          <div class="contact-item copyable" data-copy-value="hb25573@bristol.ac.uk" data-copy-label="点击复制">
            <span class="contact-icon">✉️</span>
            <div class="contact-meta">
              <span>hb25573@bristol.ac.uk</span>
            </div>
          </div>
          <div class="contact-item copyable" data-copy-value="+44 07352 200170" data-copy-label="点击复制">
            <span class="contact-icon">🌍</span>
            <div class="contact-meta">
              <span>+44 07352 200170</span>
            </div>
          </div>
          <div class="contact-item">
            <span class="contact-icon">📱</span>
            <div class="contact-meta">
              <span>18122186308</span>
              <span class="tip">国内电话暂不可用，请邮件联系</span>
            </div>
          </div>
          <div class="contact-item copyable" data-copy-value="uustaywild" data-copy-label="点击复制">
            <span class="contact-icon wechat-icon" aria-hidden="true"></span>
            <div class="contact-meta">
              <span>uustaywild</span>
            </div>
          </div>
          <div class="contact-item">
            <span class="contact-icon linkedin-icon" aria-hidden="true"></span>
            <div class="contact-meta">
              <a href="https://www.linkedin.com/in/zhiyou-zhang-1ab899385" target="_blank" rel="noreferrer">LinkedIn</a>
            </div>
          </div>
          <div class="contact-item">
            <span class="contact-icon github-icon" aria-hidden="true"></span>
            <div class="contact-meta">
              <a href="https://github.com/youshuibuzhao" target="_blank" rel="noreferrer">GitHub</a>
            </div>
          </div>
        </div>

        <div class="contact-list lang-block" data-lang="en">
          <div class="contact-item">
            <span class="contact-icon">📍</span>
            <div class="contact-meta">
              <span>Bristol, United Kingdom</span>
          ...
          <div class="contact-item copyable" data-copy-value="hb25573@bristol.ac.uk" data-copy-label="Click to copy">
            <span class="contact-icon">✉️</span>
            <div class="contact-meta">
              <span>hb25573@bristol.ac.uk</span>
            </div>
          </div>
          <div class="contact-item copyable" data-copy-value="+44 07352 200170" data-copy-label="Click to copy">
            <span class="contact-icon">🌍</span>
            <div class="contact-meta">
              <span>+44 07352 200170</span>
            </div>
          ...
          <div class="contact-item">
            ...
            <div class="contact-meta">
              <span>18122186308</span>
              <span class="tip">China phone is currently unavailable. Please contact me by email.</span>
            </div>
          </div>
          <div class="contact-item copyable" data-copy-value="uustaywild" data-copy-label="Click to copy">
            <span class="contact-icon wechat-icon" aria-hidden="true"></span>
            <div class="contact-meta">
              <span>uustaywild</span>
            </div>
        ...
        <div class="sidebar-footer">
          <button class="theme-toggle lang-block" id="theme-toggle-zh" type="button" data-lang="zh" aria-label="切换主题">🌙 / ☀️</button>
          <button class="theme-toggle lang-block" id="theme-toggle-en" type="button" data-lang="en" aria-label="Toggle theme">🌙 / ☀️</button>
        </div>
      </div>
    </aside>
    ...
    <main class="content">
      ...
      <section class="section lang-block" id="education" data-lang="zh">
        <h3>📘 Education 📘 教育</h3>
        <ul class="entry-list">
          <li>
      ...
      <section class="section lang-block" id="education-en" data-lang="en">
        <h3>📘 Education 📘</h3>
        <ul class="entry-list">
          <li>
      ...
      <section class="section lang-block" id="skills" data-lang="zh">
      ...
      <section class="section lang-block" id="skills-en" data-lang="en">
        <h3>🧩 Core Skills 🧩</h3>
        <ul class="entry-list">
          <li>
      ...
      <section class="section lang-block" id="project-experience" data-lang="zh">
        <h3>💻 Project Experience 💻 项目经历</h3>
        <div class="timeline">
      ...
      <section class="section lang-block" id="project-experience-en" data-lang="en">
        ...
        <div class="timeline">
          ...
          <article class="timeline-item">
            <div class="timeline-head">
              ...
              <span class="timeline-title">获第十三届全国大学生电子商务“创新、创意及创业”挑战赛校二等奖</span>
            </div>
          </article>
          <article class="timeline-item">
            <div class="timeline-head">
              <span class="timeline-date">2023.05</span>
              <span class="timeline-title">获第十七届“挑战杯”广东大学生课外学术科技作品竞赛广东省铜奖</span>
            </div>
          </article>
        </div>
      </section>
      ...
      <section class="section lang-block" id="honors-awards-en" data-lang="en">
        ...
        <div class="timeline">
          ...
          <article class="timeline-item">
            <div class="timeline-head">
              <span class="timeline-date">2024.06</span>
              <span class="timeline-title">Won the university-level second prize in the 13th National College Students' E-commerce Innovation, Creativity and Entrepreneurship Challenge</span>
            </div>
          </article>
          <article class="timeline-item">
            <div class="timeline-head">
              <span class="timeline-date">2023.05</span>
              <span class="timeline-title">Won the Guangdong provincial bronze award in the 17th Challenge Cup for extracurricular academic and technology works</span>
            </div>
          </article>
        </div>
      </section>
...
<script>
  (function () {
    ...
    for (var j = 0; j < copyItems.length; j += 1) {
      copyItems[j].addEventListener("click", function (event) {
        var item = event.currentTarget;
        var value = item.getAttribute("data-copy-value");
        var defaultLabel = item.getAttribute("data-copy-label");
        var copiedLabel = defaultLabel === "Click to copy" ? "Copied" : "已复制";

        if (navigator.clipboard && value) {
          navigator.clipboard.writeText(value).then(function () {
            item.setAttribute("data-copy-label", copiedLabel);
            item.classList.add("is-copied");
            window.setTimeout(function () {
              item.setAttribute("data-copy-label", defaultLabel);
